...
const ZarrMultivecRowDataFetcher = function ZarrMultivecRowDataFetcher(HGC, ...args) {
  ...
  if (!new.target) {
    ...
    class ZarrMultivecRowDataFetcherClass {
    ...
    return new ZarrMultivecRowDataFetcherClass(...args);
} // end function wrapper


ZarrMultivecRowDataFetcher.config = {
    type: 'zarr-multivec-row',
};

export default ZarrMultivecRowDataFetcher;
